...
Route::get('/crypto/search', [CryptoMarketController::class, 'showSearch']);
...
Route::get('/crypto/{cryptoId}', [CryptoMarketController::class, 'showCrypto'])->middleware(Authenticate::class);

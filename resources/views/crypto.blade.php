...
{{--                <button type="button" name="sell_button" id="sell_button" class="bg-white border hover:text-indigo-500 font-bold py-2 px-4">SELL</button>--}}
            ...
            <div id="buy_appear rounded">
                <form action="/crypto/{{$crypto['id']}}/buy" method="get">
                    ...
                    <button type="button" class="text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" @click="showModal = true">Buy</button>
